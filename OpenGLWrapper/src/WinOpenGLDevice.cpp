...
#if _DEBUG
	glClearColor(255.0f/255.0f, 204.0f/255.0f, 204.0f/255.0f, 1.0f);
#else
...
bool OpenGLDevice::privInitWindow()
{
	...
	wc.lpszClassName = "CSC 461: Winter 2024";//title.getCString();					// Set The Class Name
	...
	hWnd = CreateWindowEx(dwExStyle,				// Extended Style For The Window
		"CSC 461: Winter 2024",//title.getCString(),				// Class Name
		"CSC 461: Winter 2024",//title.getCString(),					// Window Title
...
bool OpenGLDevice::privKillWindow()
{
	...
	if(!UnregisterClass("CSC 461: Winter 2024", hInstance))
